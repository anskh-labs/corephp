...
namespace Corephp\Component\Escaper;
 ...
 * @since v1.0.0
 * @package Corephp\Component\Escaper
 */
class Escaper
{
     ...
     * @return array|string
     */
    protected function toUtf8($string):array|string
    {
     ...
     * @return array|string
     */
    protected function fromUtf8($string):array|string
    {
        if ($this->getEncoding() === 'utf-8') {
            return $string;
        }
     ...
     * @return array|string
     */
    protected function convertEncoding($string, $to, $from): array|string
    {
